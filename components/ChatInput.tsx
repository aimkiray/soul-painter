...
export default function ChatInput({ onSend, isLoading, initialPrompt = '', onClearChat, onOpenSettings }: ChatInputProps) {
  ...
  return (
    <div className="flex-shrink-0 w-full max-w-3xl mx-auto px-2 sm:px-3 pb-2 border-t md:border-t-0 border-[#AAA]">
      ...
      <div className={`${paramsOpen ? '' : 'hidden'} sm:block w-full mb-1 space-y-1`}>
